...
/**
 * description:TODO  分流水位线测试,输入 a 1,b 1,a 5
 * TODO 每个逻辑分区都要同步水位线，时钟一样
 * Created by thinkpad on 2021-09-22
 */
public class Example6_fenliuAndWaterMarks {
...
//                        设置延迟时间为0S
                ...
                .process(new ProcessWindowFunction<Tuple2<String, Long>, Object, String, TimeWindow>() {
                    ...
                    public void process(String s, Context context, Iterable<Tuple2<String, Long>> elements, Collector<Object> out) throws Exception {
                        out.collect("key为：" + s + "窗口触发了，共：" + elements.spliterator().getExactSizeIfKnown());
                    }
                })
                .print();
