 ...
 */
public class Example_5kafkaConsumer {
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("key.deserializer",      //key的反序列化
                "org.apache.kafka.common.serialization.StringDeserializer");
        properties.setProperty("value.deserializer",    //value的反序列化
                "org.apache.kafka.common.serialization.StringDeserializer");
        properties.setProperty("auto.offset.reset", "latest");  //offset
        env
                ...
                .keyBy(r -> r.windowEnd)   //继续分布式，使用窗口结束时间进行分流（每个分区就是每个窗口）
                .process(new TopN(3))
                .print();
